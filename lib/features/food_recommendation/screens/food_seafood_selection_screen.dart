...
import 'package:template/features/food_recommendation/models/seafood_menu.dart';
import 'package:template/features/food_recommendation/screens/food_final_screen.dart';

/// 해산물 요리 선택 화면
class FoodSeafoodSelectionScreen extends StatelessWidget {
  /// [FoodSeafoodSelectionScreen] 생성자
  const FoodSeafoodSelectionScreen({
          ...
          children: [
            ...
            Padding(
              ...
              child: Align(
                ...
                child: Text(
                  'food.seafood_selection_title'.tr(),
            ...
            Expanded(
              child: Padding(
                ...
                child: GridView.builder(
                  ...
                  itemCount: SeafoodMenu.menus.length,
                  itemBuilder: (context, index) {
                    final menu = SeafoodMenu.menus[index];
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    // 랜덤으로 메뉴 선택
                    final randomIndex =
                        (SeafoodMenu.menus.length * 0.5).floor() % SeafoodMenu.menus.length;
                    final randomMenu = SeafoodMenu.menus[randomIndex];
